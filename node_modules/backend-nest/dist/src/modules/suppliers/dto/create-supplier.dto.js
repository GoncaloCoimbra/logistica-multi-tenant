...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(8, { message: 'NIF deve ter no mínimo 8 dígitos' }),
    (0, class_validator_1.MaxLength)(9, { message: 'NIF deve ter no máximo 9 dígitos' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(9, { message: 'Telefone inválido' }),
    __metadata("design:type", String)
