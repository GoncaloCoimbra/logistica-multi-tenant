...
let CompaniesController = CompaniesController_1 = class CompaniesController {
    ...
    async findAll(req) {
        ...
        if (!req.user.companyId) {
            ...
            this.logger.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
            throw new common_1.BadRequestException('Utilizador sem empresa associada');
        }
    ...
    async findOne(id, req) {
        ...
        if (req.user.role === client_1.Role.ADMIN && req.user.companyId !== id) {
            ...
            this.logger.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
            throw new common_1.BadRequestException('Não pode aceder dados de outra empresa');
        }
    ...
    async update(id, updateCompanyDto, req) {
        ...
        if (req.user.role === client_1.Role.ADMIN && req.user.companyId !== id) {
            ...
            this.logger.error(`   🏢 Empresa do ADMIN: ${req.user.companyId}`);
            this.logger.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
            throw new common_1.BadRequestException('Não pode atualizar outra empresa');
        }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Criar nova empresa (SUPER_ADMIN)' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.SUPER_ADMIN, client_1.Role.ADMIN),
    (0, common_1.UseGuards)(tenant_guard_1.TenantGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Obter empresa por ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obter informações da empresa atual (ADMIN)' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.SUPER_ADMIN, client_1.Role.ADMIN),
    (0, common_1.UseGuards)(tenant_guard_1.TenantGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Obter empresa com utilizadores' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.SUPER_ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar empresa (SUPER_ADMIN)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
