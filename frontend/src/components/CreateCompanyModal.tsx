        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Ex: Empresa Logística Lda"
                />
              </div>
          ...
          <div className="mb-6 border-t border-gray-200 pt-6">
            <div className="flex items-center mb-4">
              ...
              <label htmlFor="createAdmin" className="ml-2 block text-sm font-medium text-white">
                Criar utilizador administrador da empresa
              </label>
            </div>

            {createAdmin && (
              <div className="space-y-4 p-4 rounded-lg bg-[#1e293b]/50">
                <h3 className="text-sm font-semibold text-white mb-3">Dados do Administrador</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Nome *
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 border border-gray-300 text-gray-900 rounded-lg hover:bg-amber-900/30 transition-colors font-medium"
            >
              Cancelar
            </button>
            <button
