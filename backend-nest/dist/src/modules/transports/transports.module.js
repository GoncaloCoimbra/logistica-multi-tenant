...
const transports_controller_1 = require("./controllers/transports.controller");
...
exports.TransportsModule = TransportsModule = __decorate([
    (0, common_1.Module)({
        imports: [notifications_module_1.NotificationsModule, audit_log_module_1.AuditLogModule],
        controllers: [transports_controller_1.TransportsController],
        providers: [transports_service_1.TransportsService, prisma_service_1.PrismaService],
