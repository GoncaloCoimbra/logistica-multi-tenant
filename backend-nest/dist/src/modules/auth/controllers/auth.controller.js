...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Registar novo utilizador' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obter dados do utilizador autenticado' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Atualizar perfil do utilizador' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Password alterada com sucesso' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Remover avatar' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Avatar removido com sucesso' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
